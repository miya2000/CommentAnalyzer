...
namespace TestHelper
{
    ...
    /// </summary>
    public abstract partial class CodeAnalysisHelper
    {
        ...
        internal static void VerifyFix(string language, DiagnosticAnalyzer analyzer, CodeFixProvider codeFixProvider, string oldSource, string newSource, string equivalenceKey, bool allowNewCompilerDiagnostics)
        {
            //after applying all of the code fixes, compare the resulting string to the inputted one
            var actual = GetFixResult(language, analyzer, codeFixProvider, oldSource, equivalenceKey, allowNewCompilerDiagnostics);
